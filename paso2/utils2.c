...
/*esta función se usaba en el pipex por ahora la dejo aqui aunque no se este usando...era para ahorrar lineas y funciones porque depende de que se quiera se usara una cosa u otra */
